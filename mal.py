    ...
    try:
        ...
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                ...
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam Call Ke No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "Berhasil Ngab" in gas:
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam WA Ke No {Y}{mr_am}")
            else:
            ...
            if "ok" in dekor2:
                ...
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam Sms Ke No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "erors" in gaskeun:
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam SmsKe No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Mengirim Spam Sms Ke No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "PENDING" in AmmarGamteng:
                ...
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam Sms Ke No {Y}{mr_am}{W}")
            time.sleep(1)
            ...
            if "cus" in Gwganz:
                mengetik(f"{W}[{R}×{W}] Berhasil Mengirim Spam SnsKe No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Mengirim Spam Sms Ke No {Y}{mr_am}")
            time.sleep(2)
